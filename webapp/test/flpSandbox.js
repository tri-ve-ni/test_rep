		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#materialmasterr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"materialmasterr-display": {
								"semanticObject": "materialmasterr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=materialmasterr",
									"url": sap.ui.require.toUrl("materialmasterr")
								}
							}
						}
					}
