sap.ui.define([
    ...
    function (Controller, MessageBox, Filter, FilterOperator ) {
        ...
        return Controller.extend("materialmasterr.controller.supend", {
            onInit: function () {
                // this.onReadSupData();
                var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
                oRouter.getRoute("supend").attachPatternMatched(this.onReadSupData, this);
            },
            ...
            onReadSupData: function(oEvent){
                ...
                oBusyDialog.open();
                var oFilter = new sap.ui.model.Filter("SupplierId", "EQ", sSupplierId);
            ...
            savedata1: function() {
                ...
                jQuery.ajax({
                    ...
                    url: "/v2/odata/v4/catalog/Supplier",
            ...
            savedata: function(oRecord) {
                ...
                oBusyDialog.open();
                console.log(oRecord);
                oModel.update("/Supplier(SupplierId=" + oRecord.SupplierId+")", oRecord, {
                    success: function(){
                        this.oDialog.close();
                        oBusyDialog.close();
                        this.onReadSupData();
            ...
            onDeleteRecord: function(oRecord) {
                ...
                oModel.remove("/Supplier(SupplierId=" + oRecord.SupplierId+")", {
                    success: function(response){
                        oBusyDialog.close();
                        this.onReadSupData();
                    }.bind(this),
